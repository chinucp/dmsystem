...
/**
 * @name Application_Model_Db_Users_Mapper
 * @category   DMS_Db
 * @package    DMS_Db_Interactions
 *
 * This class initiates all the database interaction calls.
 */
class Application_Model_Db_Users_Mapper extends DMS_Db_Interactions
{
	/**
	 * @name Constructor
	 * @access public
	...
	{
		$this->setDbTable('Application_Model_Db_Users_Table');
	}
