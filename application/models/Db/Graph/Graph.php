<?php
/**
 * @name Application_Model_Db_Graph_Graph
 *
 * This class initiates all the database interaction calls.
 */
class Application_Model_Db_Graph_Graph extends Application_Model_Db_Graph_GraphMapper
{
	protected $_jpgraph;
	protected $_util;
	protected $_mapper;
	...
	public function __construct($tableName = null)
	{
		...
		$this->_mapper = new Application_Model_Db_Graph_Mapper();
	}
