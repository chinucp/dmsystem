...
/**
 * @name Application_Model_Db_Graph_Mapper
 * @category   DMS_Db
 * @package    DMS_Db_Interactions
 *
 * This class initiates all the database interaction calls.
 */
class Application_Model_Db_Graph_Mapper extends DMS_Db_Interactions
{
	/**
	 * @name Constructor
	 * @access public
	...
	{
		empty($tableName) ? $this->setDbTable('Application_Model_Db_Graph_Table') : $this->setDbTable('Application_Model_Db_Graph_Table', $tableName);
	}
    ...
    private function getDisplayItems()
    {
        ...
        foreach ($resultSetArray as $rowArray) {
        	$usersManager = new Application_Model_Db_Graph_Manager();
